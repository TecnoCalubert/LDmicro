...
static void generateNetzerOpcodes(BinOp *Program, int MaxLabel, OpcodeMeta *pOpcodeMeta, FILE *f = NULL);
...
static void ifVariable_X_Variable(BinOp *Op, BYTE NetzerOp, OpcodeMeta *pMeta, FILE *f = NULL)
{
    int src1 = Op->name1;
    int src2 = Op->name2;
