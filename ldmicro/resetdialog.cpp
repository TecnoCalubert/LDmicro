...
{
    HWND grouper = CreateWindowEx(
        0, WC_BUTTON, _("Type"), WS_CHILD | BS_GROUPBOX | WS_VISIBLE, 7, 3, 120, 85, ResetDialog, NULL, Instance, NULL);
    NiceFont(grouper);
...
{
    ResetDialog = CreateWindowClient(
        0, "LDmicroDialog", _("Reset"), WS_OVERLAPPED | WS_SYSMENU, 100, 100, 404, 95, NULL, NULL, Instance, NULL);
